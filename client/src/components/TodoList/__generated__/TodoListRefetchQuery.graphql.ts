/**
 * @generated SignedSource<<f09f32834200f6e9ca359eecd5566b1a>>
...
return {
  ...
  "params": {
    "cacheID": "4f83210980cf3e0add9e9914891bff6c",
    "id": null,
    "metadata": {},
    "name": "TodoListRefetchQuery",
    "operationKind": "query",
    "text": "query TodoListRefetchQuery(\n  $after: String\n  $first: Int = 5\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...TodoListFragment_2HEEH6\n    id\n  }\n}\n\nfragment TodoListFragment_2HEEH6 on User {\n  todos(first: $first, after: $after) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      endCursor\n    }\n    edges {\n      node {\n        id\n        ...TodoListItem_todo\n        __typename\n      }\n      cursor\n    }\n  }\n  id\n}\n\nfragment TodoListItem_todo on Todo {\n  id\n  title\n  isCompleted\n}\n"
  }
};
})();
